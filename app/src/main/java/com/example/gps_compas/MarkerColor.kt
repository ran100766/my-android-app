...
//        "Marina"    to Color.parseColor("#81D4FA")  // light blue
//    )
    val colors = listOf(
        ...
        Color.parseColor("#FFBCAAA4"), // light brown
        ...
        Color.parseColor("#FF5D4037"), // dark brown
        Color.parseColor("#FF616161")  // dark gray
    )
